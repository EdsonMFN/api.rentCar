...
public class FileRepositoryTest {
    ...
    void criarArquivoXlsx() throws Exception {
        ...
        responses.andExpect(status().isOk())
                .andDo(print())
                .andExpect(jsonPath("$.fileDto.id",is(responseFile.getFileDto().getId().intValue())))
                .andExpect(jsonPath("$.fileDto.typeFile",is(equalTo("XLSX"))))
                .andExpect(jsonPath("$.fileDto.base64",is(responseFile.getFileDto().getBase64())));
